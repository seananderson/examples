...
formatters = {
    ...
    'score':     (True,  lambda i, word, _: word.lower() if i == 0 else '_'+word.lower()),
...
keymap.update({
    ...
    # 'indirect': '&',
    # 'dereference': '*',
    '(operate equals | assign)': ' = ',
    'operate (minus | subtract)': ' - ',
    'operate (plus | add)': ' + ',
    'operate (times | asterisk | star)': ' * ',
    'operate divide': ' / ',
    # 'op mod': ' % ',
    ...
    '(operate | is) greater than': ' > ',
    '(operate | is) less than': ' < ',
    '(operate | is) equal': ' == ',
    '(operate | is) not equal': ' != ',
    '(operate | is) greater than or equal': ' >= ',
    '(operate | is) less than or equal': ' <= ',
    ...
    'Alfred go to': Key('cmd-space period'),
